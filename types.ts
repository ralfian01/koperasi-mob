...
// FIX: Added MainView and SubView type definitions to be used across navigation components.
export type MainView = 'dashboard' | 'usaha' | 'pengajuan' | 'keuangan' | 'koperasi' | 'pengaturan';
