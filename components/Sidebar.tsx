...
// FIX: Corrected the import path for MainView and SubView types from '../App' to '../types' to resolve the module export error.
import type { MainView, SubView } from '../types';
